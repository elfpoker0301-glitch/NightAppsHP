      ...
      <div className="max-w-4xl mx-auto">
        <section className="bg-white/10 backdrop-blur-lg rounded-2xl p-8">
          ...
          <div className="space-y-6 text-gray-300 leading-relaxed">
            <p>
              UTSUNO HIDETA（以下「当社」といいます）は、Night契約書（以下「本アプリ」といいます）における、
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 pl-4">
                ...
                <li>契約書データ（作成された契約書の内容、署名情報等）</li>
            ...
            <div>
              ...
              <p>
                ...
                すべての契約書データはAES-256暗号化により保護され、不正アクセス、紛失、破損、改ざん、漏洩などを防止します。
              </p>
            </div>
            ...
            <div>
              <h3 className="text-xl font-semibold text-white mb-3">第8条（プライバシーポリシーの変更）</h3>
              <p>
            ...
            <div>
              <h3 className="text-xl font-semibold text-white mb-3">第9条（お問い合わせ）</h3>
              <p>
