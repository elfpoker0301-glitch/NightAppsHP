      ...
      <div className="max-w-4xl mx-auto">
        <section className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 mb-8">
          ...
          <p className="text-gray-300">
            Night PDF（以下「本アプリ」）は、ユーザーのプライバシーを尊重し、個人情報の保護に努めています。
          </p>
        </section>
        ...
        <section className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 mb-8">
          ...
          <div className="text-gray-300 space-y-4">
            <div className="bg-white/5 rounded-lg p-6">
              ...
              <p>編集したPDFファイルは、すべて端末内に暗号化されて保存されます。</p>
            </div>
            <div className="bg-white/5 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-white mb-3">クラウド保存</h3>
              <p>本アプリは、クラウド上にデータを保存しません。すべての処理は端末内で完結します。</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 mb-8">
          ...
          <p className="text-gray-300 mb-4">
            本アプリで編集したPDFファイルやデータを第三者に提供することはありません。
          </p>
            ...
            <div className="bg-white/5 rounded-lg p-6">
              ...
              <p className="mt-4">
                ...
                <a 
                  ...
                  className="text-orange-300 hover:text-orange-200 transition-colors ml-1"
                >
                  Googleのプライバシーポリシー
                </a>
                をご確認ください。
        ...
        <section className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 mb-8">
          ...
          <div className="text-gray-300 space-y-4">
            <p>
              本アプリをアンインストールすることで、端末内に保存されたPDFファイルやデータはすべて削除されます。
            </p>
            <div className="bg-orange-500/20 rounded-lg p-4">
              <p className="text-sm">
                ⚠️ <strong className="text-white">重要：</strong>
                アンインストール前に、必要なPDFファイルは他の場所にバックアップしてください。
                削除されたデータは復元できません。
              </p>
            </div>
          </div>
