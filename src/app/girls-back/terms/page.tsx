    ...
    <Layout title="Girls Back - 利用規約" description="Girls Backの利用規約">
      <div style={{ maxWidth: 800, margin: "0 auto" }}>
        ...
        <div style={{ background: "var(--bg2)", border: "1px solid var(--line)", borderRadius: 16, padding: "32px", marginBottom: 20 }}>
          ...
          <p style={{ fontSize: 14, color: "var(--mid)", lineHeight: 1.8, margin: 0 }}>本規約は、Girls Back（以下「本アプリ」）の利用に関して適用されます。本アプリをダウンロード・使用することで、本規約に同意したものとみなします。</p>
        </div>
        ...
        <div style={{ background: "var(--bg2)", border: "1px solid var(--line)", borderRadius: 16, padding: "32px", marginBottom: 20 }}>
          ...
          <p style={{ fontSize: 14, color: "var(--mid)", lineHeight: 1.8, margin: 0 }}>本アプリはアフターバック収入の個人管理を目的としています。違法な目的または第三者に損害を与える目的での使用を禁止します。</p>
        </div>
